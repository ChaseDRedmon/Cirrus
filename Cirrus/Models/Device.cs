...
// These fields attempt to follow the specification as closely as possible
    ...
    /// </summary>
    [JsonPropertyName("co2")]
    public double? CO2PartsPerMillion { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("batt_co2")]
    public int CO2SensorBatteryLowIndicator { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("lightning_day")]
    public int? LightningStrikesPerDay { get; set; }

    /// <summary>
    /// The number of lightning strikes within the hour
    /// </summary>
    [JsonPropertyName("lightning_hour")]
    public int? LightningStrikesPerHours { get; set; }

    /// <summary>
    /// The time of the last lightning strike (in UTC)
    /// </summary>
    [JsonPropertyName("lightning_time")]
    public DateTimeOffset? LastLightningStrikeTime { get; set; }

    /// <summary>
    /// Distance of the lightning strike from the sensor in miles
    /// </summary>
    [JsonPropertyName("lightning_distance")]
    public double? LightningStrikeDistance { get; set; }
